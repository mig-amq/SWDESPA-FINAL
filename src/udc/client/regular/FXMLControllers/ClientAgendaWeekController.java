...
//    private ObservableList<Agenda> sun;
    ...
    private void setList() throws Exception {
        ...
        {
            startTemp = model.getDbController().getAppointments(model.getAccount().getId(), "normal").get(i).getStartTime();
            endTemp = model.getDbController().getAppointments(model.getAccount().getId(), "normal").get(i).getEndTime();
